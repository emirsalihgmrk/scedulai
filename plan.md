...
| **Transkript çekme**             | `youtube-transcript` benzeri kütüphaneler / resmi altyazı verisi         | YouTube altyazılarını programatik çekmek için. Hukuki/ToS sınırlarına dikkat et.                                                   |
...
- Kullanıcı bir YouTube linki girer veya sen sabit bir video verirsin → transkript çekilir.
